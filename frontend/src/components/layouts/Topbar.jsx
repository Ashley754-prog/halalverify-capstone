...
export const AppTopbar = ({ isSidebarOpen, onToggleSidebar, onProfileClick }) => (
            ...
            <div className="flex items-center gap-3">
                ...
                <div className="flex items-center">
                    <button
                        ...
                        className="ml-2 h-9 w-9 rounded-full bg-slate-700 flex items-center justify-center border border-slate-600 text-white text-sm font-semibold"
                    >
                        <User size={16} />
                    </button>
                </div>
