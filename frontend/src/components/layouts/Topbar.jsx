            ...
            <div className="flex items-center gap-2 shrink-0">
                {userRole ? (
                    <button
                        ...
                        className="ml-2 h-9 w-9 rounded-full bg-slate-700 hover:bg-slate-600 transition flex items-center justify-center border border-slate-600 text-white text-sm font-semibold shrink-0"
                    >
                        <User size={16} />
                    </button>
                ) : (
