...
export const Login = ({ onLogin, layout = 'login' }) => {
    ...
    const handleSignIn = () => {
        const role = email.trim() === 'admin@halalverify.com' ? 'admin' : 'user';
                ...
                <div className={`flex items-center justify-center bg-white p-6 md:p-12 transition-all duration-500 md:p-12 ${layout === 'create' ? 'md:order-1' : 'md:order-2'}`}>
                    <div className={`flex min-h-0 md:min-h-[420px] w-full max-w-sm flex-col justify-center transition-all duration-500 ease-out ${mounted ? 'opacity-100 translate-x-0' : layout === 'create' ? 'opacity-0 -translate-x-8' : 'opacity-0 translate-x-8'}`}>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        placeholder="admin@halalverify.com"
                        ...
                        <button
                            ...
                            className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-600 py-3.5 font-bold tracking-wide text-white transition hover:bg-emerald-700 active:scale-95 duration-150 shadow-md shadow-emerald-600/10"
                        >
                            Sign In 
                        </button>
