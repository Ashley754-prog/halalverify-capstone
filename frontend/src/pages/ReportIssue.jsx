...
export const ReportIssue = () => {
    ...
    const [form, setForm] = useState({
        issueType: '',
        relatedTo: 'product', // 'product' | 'establishment' | 'logo'
        name: '',
        description: '',
    });
        ...
        <div className="p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-6 flex-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
                <form onSubmit={handleSubmit} className="lg:col-span-2 bg-white rounded-2xl border border-slate-200 shadow-sm p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-6">
                    ...
                    <button
                        type="submit"
                        className="w-full flex items-center justify-center gap-2 rounded-xl bg-emerald-600 py-3 sm:py-3.5 font-bold text-xs sm:text-sm text-white tracking-wide transition hover:bg-emerald-700 active:scale-[0.98] duration-150 shadow-md shadow-emerald-600/10"
                    >
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-4 sm:p-6">
                        ...
                        <ul className="text-xs text-emerald-700 space-y-2">
                            ...
                            <li className="flex items-start gap-2"><span className="mt-0.5 text-emerald-500 font-bold">•</span> Suspicious logo was marked as "Valid"</li>
            ...
            <Modal
                ...
                footer={[
                    <button key="cancel" type="button" onClick={() => setShowConfirmModal(false)} className="rounded-xl border border-slate-200 px-4 py-2 text-xs sm:text-sm font-semibold text-slate-600 hover:bg-slate-50">Cancel</button>,
                    <button key="submit" type="button" onClick={confirmSubmission} className="rounded-xl bg-emerald-600 px-4 py-2 text-xs sm:text-sm font-semibold text-white hover:bg-emerald-700">Submit Report</button>
                ]}
            >
